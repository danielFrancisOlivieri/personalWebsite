    ...
    return (
      <div>
        <PageHeader color="is-dark" title="Medium">
          Medium is where I ramble and rant and tell stories. I orginally was going to use it as a coding blog, I do not like having to use Gist for all my code snippets. So I created this site.
          <br /><br />
